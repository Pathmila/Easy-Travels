...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$count = mysqli_num_rows($result5);
			...
			$sql4="Insert into assign(resvid,hotel,guide,vehicle,package,price,date,name,address,email,telephone)
			values ('".$resvid."' ,'".$hotel."','".$guide."','".$vehicle."','".$pack."','".$price."','".$date."','".$name."','".$address."','".$email."','".$telephone."')";
			//echo $sql4;
			...
			$sql2= "Delete from resavation where resvid='".$_SESSION['reservation']."' ";
			//echo $sql2;
