	...
	$year= $array[2];
		echo"
			<center><table class='graph'>
				<caption>Revenue For $year</caption>
				<thead>
					<tr>
						<th style='color:black; font-size:18px;' scope='col'>Month</th>
						<th style='color:black; font-size:18px;' scope='col'>Amount</th>
					</tr>
				</thead>
			<tbody>";
			...
			for($month1=1; $month1<13 ; $month1++){
				...
				while($row1=$result->fetch_assoc()){
					...
					/*	echo "<tr>";
						...
						//<td><span>&nbsp$point%</span></td>
						
					*/
					echo"
						<tr style='height:$point%; color:black;'>
							<th scope='row'><b>$wordmonth1</b></th>
							<td><span>&nbsp$sum</span></td>
						</tr>";
					}
				}
			}
