<?php
	...
	$sql="select * from assign where hotel='".$_SESSION['uid']."' order by resvid desc";
	//echo $sql;
	...
	while($row=$result->fetch_assoc()){
		...
		echo "<td align='center'>".$row['travelers']."</td>";
		echo "<td align='center'>".$row['single']."</td>";
		echo "<td align='center'>".$row['doublerooms']."</td>";
