<?php
	...
	while($row=$result2->fetch_assoc()){
		...
		echo"
		<center><form method='GET' action='packages_for_destination_page.php' class='table' align='center'>
			<div class='row'>
				<br /><input type='text' class='destext'  value='".$row['name']."' readonly>
			</div>
			</div><br/>
			<div class='row'>
				<center><input type='submit' class='destbtn' name='destsubmit' value='View Travel Packages in ".$row['name']."'></center>
			</div>
			</div><br/>
			<div class='row'>
				<div class='line'>
