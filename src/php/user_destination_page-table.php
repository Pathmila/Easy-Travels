<?php
	...
	while($row=$result2->fetch_assoc()){
		...
		<form name='box' method='get' action='user_destination_page.php' class='table' align='center'>
			<div class='column'>
				<div class='content'>
					<input type='text' name='destname' value='".$name."' style='font-size:18px; font-weight:bold; color:white; background-color:transparent; height:50px; text-align:center' readonly><br />
